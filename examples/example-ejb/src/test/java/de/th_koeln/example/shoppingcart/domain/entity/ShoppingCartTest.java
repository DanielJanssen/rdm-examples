...
import de.th_koeln.example.shoppingcart.domain.entity.UserAccount;
...
public class ShoppingCartTest {
	...
	private Article getDummyArticle2() {
		return new Article.Builder().withNumber(12346).withName("Name").withDescription("Description").forPrice(getDummyPrice()).build();
	}
